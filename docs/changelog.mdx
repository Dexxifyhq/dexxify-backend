...
<Update label="2026-09-17">
  ...
  **Full error response documentation.** Every endpoint now documents its actual success and error responses (`400`/`401`/`403`/`404`/`409`) in the [API Reference](/api-reference), matching what the API actually returns.
</Update>
